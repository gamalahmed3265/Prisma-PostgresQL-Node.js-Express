...
*/
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'SUPERVISOR', 'SUPERADMN');
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favoriteId_fkey" FOREIGN KEY ("favoriteId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
